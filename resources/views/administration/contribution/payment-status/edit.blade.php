...
<div class="card card-outline card-primary card-body">
    <div class="list-group-item d-flex justify-content-between">
        ...
        <div class="card-tools">
            <a class="btn btn-sm btn-primary mt-1" href="{{ route('administration.payement.status.index') }}">Kembali</a>
        </div>
    </div>
    <div class="list-group-item">
        ...
        @else
        <form method="POST" action="{{ url('administration/payement/status/' . $ledger->general_ledger_id) }}" class="form-horizontal">
            @csrf
            {!! method_field('PUT') !!}
