...
use App\Models\PaymentProve;
use App\Http\Requests\StorePaymentProveRequest;
use App\Http\Requests\UpdatePaymentProveRequest;

class PaymentProveController extends Controller
{
    /**
