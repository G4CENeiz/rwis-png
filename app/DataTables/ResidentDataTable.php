...
class ResidentDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'resident.action')
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('resident_id'),
            Column::make('nik'),
            Column::make('name'),
            Column::make('birth_place'),
            Column::make('birth_date'),
            Column::make('gender'),
            Column::make('blood_type'),
            Column::make('religion_id'),
            Column::make('citizenship'),
            Column::make('profession_id'),
            Column::make('marital_status_id'),
